    ...
    <div class="card mt-2">
        <div class="card-body">
            ...
            if(empty($file)) {
                ...
                echo"Apalikasi Pembayaran SPP digunkan untuk mempermudah dalam mencatat pembayaran siswa / siswi disekolah.";
                echo"<hr>";
...
<section src="../js/bootstrap.bundle.min.js"></section>
</body>
</html>